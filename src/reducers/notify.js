import { SET_NOTIFICATIONS, ADD_NOTIFICATION, REMOVE_NOTIFICATION, REMOVE_ALL_NOTIFICATIONS, SET_NOTIFICATION_AS_READED } from '../actions/notify';

function setNotification(state, notifications) {
...
export default function notifyReducer(state = [], action) {
  switch (action.type) {
    case SET_NOTIFICATIONS:
      return setNotification(state, action.notifications);
