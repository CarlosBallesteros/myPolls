...
export default class NotificationsDetail extends Component {
  ...
  render() {
    ...
    const loadMore = maxMessages < messages.length ? <button style={{'marginLeft': '10px'}} className="btn btn-default pull-right" onClick={ () => this.handleLoadMoreButtonClick() }>Load More</button> : null;
